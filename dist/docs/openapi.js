    ...
    components: {
        ...
        schemas: {
            ...
            NombaWebhookPayload: {
                ...
                description: "Raw Nomba webhook JSON payload. The endpoint verifies the signature against the unmodified raw request body before parsing JSON.",
            },
            BusinessType: {
                type: "string",
            ...
            WebhookEventStatus: {
                ...
                description: "Stored webhook processing status. RECEIVED means stored, PROCESSED means handled, FAILED means processing failed.",
            },
            SubscriptionStatus: {
                type: "string",
                enum: [
            ...
            IndividualMerchantSignupRequest: {
                type: "object",
                description: "Use this when the merchant is an individual. legalName is the account holder's real name. displayName is optional and becomes the billing workspace display name.",
                required: [
                    "type",
                    "email",
                    "password",
                ...
                properties: {
                    ...
                    displayName: {
                        ...
                        description: "Optional public/workspace display name. If omitted, legalName is used.",
                    },
                    contactPhone: { type: "string", example: "+2348012345678" },
                    country: { type: "string", default: "NG", example: "NG" },
                },
            ...
            DunningPolicyCreateRequest: {
                ...
                properties: {
                    ...
                    isDefault: {
                        type: "boolean",
                        default: true,
                        description: "When true, this becomes the default policy for this business/mode and any previous default is unset.",
                    },
            ...
            DunningPolicyUpdateRequest: {
                type: "object",
                description: "All fields are optional. If steps is supplied, the full ordered retry step list is replaced.",
                properties: {
                    name: { type: "string", example: "Default Recovery Policy" },
                    status: { $ref: "#/components/schemas/DunningPolicyStatus" },
            ...
            PortalPaymentMethodSetupRequest: {
                ...
                properties: {
                    ...
                    subscriptionId: {
                        type: "string",
                        format: "uuid",
                        description: "Optional. If provided, the newly tokenized payment method is attached to this subscription after the Nomba webhook activates it.",
                    },
                    metadata: { type: "object", additionalProperties: true },
                },
            },
            ...
            SubscriptionChangePlanRequest: {
                ...
                properties: {
                    ...
                    effective: {
                        ...
                        default: "IMMEDIATE",
                        description: "IMMEDIATE applies upgrades now. Downgrades are always scheduled for currentPeriodEnd in the MVP.",
                    },
                    prorationBehavior: {
                        type: "string",
                        enum: ["CREATE_PRORATION", "NONE"],
                        default: "CREATE_PRORATION",
                        description: "CREATE_PRORATION charges the remaining-period upgrade difference. NONE switches compatible upgrades without charging.",
                    },
                    metadata: { type: "object", additionalProperties: true },
                },
            },
            ...
            DevNombaWebhookSimulateRequest: {
                ...
                properties: {
                    ...
                    tokenKey: {
                        ...
                        description: "Reusable Nomba tokenKey to attach to the payment method. If omitted, the simulator generates one.",
                    },
                    cardId: {
                        type: "string",
                        example: "tok_test_5fa12b",
                        description: "Backward-compatible alias for tokenKey in older simulator scripts.",
                    },
                    nombaCustomerId: {
                        type: "string",
                        example: "cus_8821",
                    ...
                    skipTransactionVerification: {
                        type: "boolean",
                        default: true,
                        description: "Development convenience. When true, the simulator does not call Nomba transaction lookup before settling the payment attempt.",
                    },
                },
            },
            DevRunDueBillingRequest: {
                ...
                properties: {
                    ...
                    subscriptionId: {
                        type: "string",
                        format: "uuid",
                        description: "Optional. Process only one subscription, useful for local testing.",
                    },
                    skipTransactionVerification: {
                        type: "boolean",
                        default: true,
            ...
            DevRunDueDunningRequest: {
                ...
                properties: {
                    businessId: {
                        type: "string",
                        format: "uuid",
                        description: "Business whose due scheduled dunning retries should be processed. The merchant session user must belong to this business.",
                        example: "ce640d6a-c392-488c-b81b-c66ebdf42258",
                    },
                    limit: {
                        type: "integer",
                    ...
                    skipTransactionVerification: {
                        type: "boolean",
                        default: true,
                        description: "Testing convenience. When true, a successful provider charge can settle without calling transaction lookup.",
                    },
                },
            },
    ...
    paths: {
        ...
        "/api/v1/dev/dunning/run-due": {
            post: {
                ...
                description: "Protected testing endpoint. Finds scheduled dunning attempts whose scheduledAt is due, creates a new payment attempt, charges the saved payment method, and either recovers the invoice/subscription or schedules the next dunning retry.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
        ...
        "/api/v1/merchants/signup": {
            post: {
                ...
                responses: {
                    "201": {
                        description: "Merchant created pending email verification. Testing mode currently returns verificationToken and verificationUrl directly instead of sending email.",
                    },
                },
            },
        },
        ...
        "/api/v1/merchants/forgot-password": {
            post: {
                ...
                description: "Testing mode currently returns resetToken and resetUrl directly for existing accounts instead of sending email.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
                ...
                responses: {
                    "200": {
                        description: "Password reset token created if the merchant account exists. Testing mode returns resetToken and resetUrl directly.",
                    },
                },
            },
        },
        ...
        "/api/v1/businesses/{businessId}/logs": {
            get: {
                ...
                description: "Dashboard-facing log feed for future merchant UI. Returns persisted structured events from billing, payments, dunning, and webhook delivery paths.",
                parameters: [
        ...
        "/api/v1/businesses/{businessId}/logs/summary": {
            get: {
                ...
                description: "Returns counts by severity and top event names for the selected filters. Useful for a dashboard overview.",
                parameters: [
                    { name: "businessId", in: "path", required: true, schema: { type: "string", format: "uuid" } },
                    {
                        name: "severity",
        ...
        "/api/v1/dunning-policies": {
            post: {
                ...
                description: "Creates a merchant-configurable retry schedule and final action for failed recurring payments. If isDefault=true, it becomes the active default for the API key business/mode.",
                parameters: [
                    {
                        name: "Idempotency-Key",
                        in: "header",
        ...
        "/api/v1/dunning-policies/{id}": {
            ...
            patch: {
                ...
                description: "Updates policy fields. If steps is provided, the existing ordered retry steps are replaced. A disabled policy cannot be default.",
                parameters: [
                    { name: "id", in: "path", required: true, schema: { type: "string", format: "uuid" } },
                ],
                requestBody: {
        ...
        "/api/v1/portal/sessions/{token}/invoices/{invoiceId}/pay": {
            post: {
                ...
                description: "Public subscriber-facing endpoint. Uses the portal token to retry payment for one of the customer's open or failed invoices using the subscription's active reusable payment method.",
                parameters: [
                    { name: "token", in: "path", required: true, schema: { type: "string" } },
        ...
        "/api/v1/portal/sessions/{token}/payment-methods/setup-checkout": {
            post: {
                ...
                description: "Creates a Nomba checkout for the customer to add a new reusable payment method. If subscriptionId is supplied, Recurr attaches the new payment method to that subscription after Nomba sends the tokenized-card webhook.",
                parameters: [
                    { name: "token", in: "path", required: true, schema: { type: "string" } },
                    {
                        name: "Idempotency-Key",
        ...
        "/api/v1/portal/sessions/{token}/subscriptions/{subscriptionId}/cancel": {
            post: {
                ...
                description: "Defaults to cancel-at-period-end. Immediate cancellation is available only if cancelAtPeriodEnd=false is sent.",
                parameters: [
                    { name: "token", in: "path", required: true, schema: { type: "string" } },
        ...
        "/api/v1/portal/sessions/{token}/subscriptions/{subscriptionId}/change-plan": {
            post: {
                ...
                description: "Uses the same MVP rules as merchant change-plan: immediate prorated upgrade, period-end downgrade.",
                parameters: [
                    { name: "token", in: "path", required: true, schema: { type: "string" } },
                    { name: "subscriptionId", in: "path", required: true, schema: { type: "string", format: "uuid" } },
                    {
        ...
        "/api/v1/subscriptions/{id}/change-plan": {
            post: {
                ...
                description: "Upgrades can apply immediately and charge the prorated remaining-period difference. Downgrades are scheduled for currentPeriodEnd and applied by the billing worker at renewal.",
                parameters: [
                    { name: "id", in: "path", required: true, schema: { type: "string", format: "uuid" } },
                    {
                        name: "Idempotency-Key",
                ...
                responses: {
                    ...
                    "409": {
                        description: "Subscription inactive, same plan, unusable payment method, or incompatible immediate proration",
                    },
                },
            },
        },
        ...
        "/api/v1/webhooks/events": {
            get: {
                ...
                description: "Dashboard/testing endpoint for inspecting provider webhooks Recurr has received and stored. Use the merchant dashboard access token, not a business API key.",
                parameters: [
                    { $ref: "#/components/parameters/Limit" },
                    { $ref: "#/components/parameters/Cursor" },
                    {
        ...
        "/api/v1/webhooks/events/{id}": {
            get: {
                ...
                description: "Returns the raw stored webhook payload, headers, processing status, and failure reason if processing failed.",
                parameters: [
                    {
                        name: "id",
                        in: "path",
        ...
        "/api/v1/webhooks/nomba": {
            post: {
                ...
                description: "Verifies the nomba-signature HMAC-SHA256 signature against the raw request body, stores the raw event, and treats payload requestId values idempotently. Timestamp tolerance is supported when a timestamp header is configured/sent.",
                parameters: [
                    {
                        ...
                        required: true,
                        schema: { type: "string" },
                        description: "Configurable with NOMBA_WEBHOOK_SIGNATURE_HEADER. HMAC-SHA256 hex digest of the raw body using NOMBA_WEBHOOK_SECRET.",
                    },
                    {
                        ...
                        required: false,
                        schema: { type: "string" },
                        description: "Optional. Configurable with NOMBA_WEBHOOK_TIMESTAMP_HEADER. Required only when NOMBA_WEBHOOK_REQUIRE_TIMESTAMP=true.",
                    },
                    {
                        ...
                        required: false,
                        schema: { type: "string" },
                        description: "Optional. Configurable with NOMBA_WEBHOOK_EVENT_ID_HEADER. If absent, event.requestId is used for event idempotency.",
                    },
                ],
                requestBody: {
                    required: true,
                ...
                responses: {
                    "200": {
                        description: "Webhook accepted. Duplicate provider events return duplicate=true and are not processed again.",
                    },
                    "400": {
